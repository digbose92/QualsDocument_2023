...
\title{\textbf{\Large{Towards multimodal contextual reasoning approaches for content understanding: Taxonomies, Benchmarks and Challenges}}}
...
% Research Topic 1
\include{Visual_contextual_reasoning}
\include{contextual_human_affect_perception}
\include{dynamic_source_context_fusion}
