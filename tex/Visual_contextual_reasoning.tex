...
\end{tabular}}
\vspace{1mm}
\caption{Mean average precision (mAP) and average Spearman correlation of different models on human verified evaluation set (N=1883 shots). NA: End-to-end models used instead of features. For 3D conv models, the backbone network is mentioned inside brackets. }
